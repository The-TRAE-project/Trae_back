...
public class OperationDtoMapper implements Function<Operation, OperationDto> {
	...
	public OperationDto apply(Operation o) {
		...
		return new OperationDto(o.getId(), o.getPriority(), o.getName(), o.getDescription(), o.getStartDate(),
				o.getAcceptanceDate(), o.getPlannedEndDate(), o.getRealEndDate(), o.getPeriod(), o.isEnded(),
				o.isInWork(), o.isReadyToAcceptance(),
