...
public class ShortOperationDtoMapper implements Function<Operation, ShortOperationDto> {
	...
	public ShortOperationDto apply(Operation o) {
		...
		return new ShortOperationDto(o.getId(), p.getId(), o.getPriority(), o.getName(), o.getDescription(),
				o.getTypeWork().getName(), o.getTypeWork().getId(), o.isEnded(), o.isInWork(), o.isReadyToAcceptance());
	}
